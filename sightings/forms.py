...
class AddForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field in self.fields:
            if field == 'unique_squirrel_id':
                help_text = self.fields[field].help_text
                self.fields[field].help_text = "Enter in form hectare_ID-shift-HHMM-number Ex: 1C-AM-1234-01"
            elif field == 'date':
                help_text = self.fields[field].help_text
                self.fields[field].help_text = "Enter in form YYYY-MM-DD HH:MM:SS"
